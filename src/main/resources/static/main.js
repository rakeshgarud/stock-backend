...
var routes = [
    { path: '', component: _list_stocks_list_stocks_component__WEBPACK_IMPORTED_MODULE_1__["ListStocksComponent"] },
    ...
    { path: 'all-data-download', component: _all_load_data_all_load_data_component__WEBPACK_IMPORTED_MODULE_5__["AllLoadDataComponent"] }
];
...
var EquityComponent = /** @class */ (function () {
    ...
    EquityComponent.prototype.loadEquityData = function () {
        console.log("Loading data into DB");
        this.stockservice.loadEquity().subscribe(function (data) {
        });
    };
    ...
    EquityComponent.prototype.symbolDropDown = function (symbol) {
        this.search.symbol = symbol;
        this.getEquities();
    };
    EquityComponent.prototype.getSymbols = function () {
        var _this = this;
...
var PremiumdkComponent = /** @class */ (function () {
    ...
    PremiumdkComponent.prototype.getEquities = function () {
        var _this = this;
        this.search.filter = this.filtersRequest;
...
var StockService = /** @class */ (function () {
    ...
    StockService.prototype.loadEquity = function () {
        return this.http.get(this.baseUrl + 'stock/load-equity');
    };
    StockService.prototype.loadStockOptions = function () {
        return this.http.get(this.baseUrl + 'stock/load-stock-options');
    };
    StockService.prototype.getEquityByFilter = function (search) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]();
        return this.http.post(this.baseUrl + 'stock/search/equity', search);
    };
    // Service for Premium DK
    StockService.prototype.getPremiumDKByFilter = function (search) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]();
        return this.http.post(this.baseUrl + 'stock/search/premiumdk', search);
    };
