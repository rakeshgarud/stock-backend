...
var StockService = /** @class */ (function () {
    ...
    StockService.prototype.getPremiumDKByFilter = function (search) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]();
        return this.http.post(this.baseUrl + this.equityEndPoint + 'nifty/premiumdk', search);
    };
    ...
    StockService.prototype.loadStockOptions = function () {
        return this.http.get(this.baseUrl + this.equityEndPoint + 'load-stocks');
    };
    ...
    StockService.prototype.getStocksOptionsByFilter = function (search) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]();
        return this.http.post(this.baseUrl + this.equityEndPoint + 'search/stocks', search);
    };
